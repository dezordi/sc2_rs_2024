...
brasil_cases <- read.csv("~/pessoal/sars_rs/2022-10-05_SARS_RS/data/covid_19_br.csv", header=TRUE, sep=";")
...
rs_gamma_lineage_plot
br_gamma_lineage_plot
#Delta
...
rs_delta_lineage_plot
br_delta_lineage_plot
...
rs_delta_lineage_plot
br_delta_lineage_plot
rs_omicron_lineage_plot
br_omicron_lineage_plot
...
# Organizando os 6 plots restantes em 3 linhas de 2 colunas
...
# Combina os dois grids em uma única folha A4
